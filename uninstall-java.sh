...
# If the command above produces any output like /path/to/jre1.6.0_34/bin/pack200 remove the directory that is parent of bin, 
# like this: 
sudo rm -rf /path/to/jre1.6.0_34

# This is an answer on www.askubuntu.com. Author of this answer is Eric Carvalho.
# URL: https://askubuntu.com/questions/84483/how-to-completely-uninstall-java